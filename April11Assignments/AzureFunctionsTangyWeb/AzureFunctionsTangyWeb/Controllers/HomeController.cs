...
namespace AzureFunctionsTangyWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(SalesRequest salesRequest)
        {
            ...
            client.BaseAddress = new Uri("https://tangfun2-gchnhjhvdbdvh8en.eastasia-01.azurewebsites.net/api/OnSalesUploadWriteToQueue");
            //client.BaseAddress = new Uri("http://localhost:7117/api/");
